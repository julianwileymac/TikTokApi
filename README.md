...
# Clone of the Unofficial TikTok API in Python (credit: DavidTeather)

This is a clone of the unofficial api wrapper for TikTok.com in python (Original: https://github.com/davidteather/TikTok-Api). With this api you are able to call most trending and fetch specific user information as well as much more.
